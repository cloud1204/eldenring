...
def is_verdict_expected(score, verdict, expected_verdict):
    ...
    # this should be use in random solutions
    elif expected_verdict == "almost_surely_correct":
        return verdict in ["Correct", "Wrong Answer"]
    # this should be use in solutions with large constant factors
    elif expected_verdict == "time_limit_or_correct":
        return verdict in ["Time Limit Exceeded", "Correct"]
