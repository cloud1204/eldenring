...
valid_verdicts = (model_solution_verdict, 'correct', 'almost_surely_correct', 'time_limit_or_correct', 'time_limit', 'memory_limit', 'incorrect', 'runtime_error', 'failed', 'time_limit_and_runtime_error', 'partially_correct')
...
def is_ignored(file_name):
    return has_ending(file_name, ['.exe', '.class', '~', '.compile.debug'])
